...
int RCar4Frames::start(class RCarISPDevice *isp, class ipa::rppx1::IPAProxyRppX1 *ipa)
{
...
void RCar4Frames::stop(class RCarISPDevice *isp, class ipa::rppx1::IPAProxyRppX1 *ipa)
{
